...
class Pai_pro extends StatefulWidget {
  @override
  _Pai_proState createState() => _Pai_proState();
}

class _Pai_proState extends State<Pai_pro> {
  var product_list =[
    {
         "id":"6",
         "name": "Nature",
         "picture1":"images/products/paint.jpg",
         "picture2":"images/products/paint.jpg",
         "picture3":"images/products/paint.jpg",
         "price":12000,
         "avg_rating":4,
         "made_of":"silk,water colors",
         "description":"this is a painting of nature",
         "category":"painting"
    },
    ];
  @override
