...
class Scu_pro extends StatefulWidget {
  @override
  _Scu_proState createState() => _Scu_proState();
}

class _Scu_proState extends State<Scu_pro> {
  var product_list = [
    {
      "id": "3",
      "name": "Buddha_Statue",
      "picture1": "images/products/buddhastatue.jpg",
      "picture2": "images/products/buddhastatue.jpg",
      "picture3": "images/products/buddhastatue.jpg",
      "price": 12000,
      "made_of": "Clay",
      "description": "This is a statue of buddha.",
      "category": "Sculpture",
      "avg_rating": 5,
    },
  ];
